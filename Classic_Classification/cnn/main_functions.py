...
def jitter_test(dataset, x_train, y_train, x_test,  y_test, input_shape,  nb_classes,rat,sp_str):
...
def tw_test(dataset, x_train, y_train, x_test,  y_test, input_shape,  nb_classes, rat,sp_str):
    def Augmentation(function, data, label_data, class_under, nb):
      underReprClass = list()
...
def SMOTE_test(dataset, x_train, y_train, x_test,  y_test, input_shape,  nb_classes, sp_st='all'):
     ...
     model = Classifier_RESNET('models/SMOTE', input_shape, nb_classes, False)
     model.build_model(input_shape, nb_classes)
...
def ADASYN_test(dataset, x_train, y_train, x_test,  y_test, input_shape,  nb_classes):
     ...
     model = Classifier_RESNET('models/ADASYN/', input_shape, nb_classes, False)
     model.build_model(input_shape, nb_classes)
     y_over = to_categorical(ds.class_offset(yo, dataset), nb_classes)
     model.fit(Xo, y_over)
