...
for i in range(len(folders)):
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = raw_data(dataset, x_train, y_train, x_test,  np.argmax(y_test, axis = 1), input_shape,  nb_class,m)
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = ROS_test(dataset, x_train, y_train, x_test,  np.argmax(y_test, axis = 1), input_shape,  nb_class, sp_str,m)
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = jitter_test(dataset, x_train, y_train, x_test, np.argmax(y_test, axis = 1), input_shape,  nb_class, sp_str,m)
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = tw_test(dataset, x_train, y_train, x_test,  np.argmax(y_test, axis = 1), input_shape,  nb_class, sp_str,m)
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = SMOTE_test(dataset, x_train, y_train, x_test,  np.argmax(y_test, axis = 1), input_shape,  nb_class,m, sp_str)
    ...
    for i in range(3):
        taccu,tmcc, tf, trec, tpres, tg = ADASYN_test(dataset, x_train, y_train, x_test,  np.argmax(y_test, axis = 1), input_shape,  nb_class,m, sp_str)
